package com.business.admin.utils.imgutil;
...
public class pic {  
    ...
    public static void main(String[] args) {  
        ...
        BufferedImage xz = tt.loadImageLocal("D:\\xinxi\\xz.png"); //加载本地 
        BufferedImage zt = tt.loadImageUrl("http://192.168.1.218//group1/M00/00/0B/wKgB2lrESYuATOEUAAC_W4Rpfx0006.jpg");
//      BufferedImage b = tt  
//              .loadImageLocal("E:\\文件(word,excel,pdf,ppt.txt)\\zte-logo.png");  
//         tt.writeImageLocal("D:\\xinxi\\dazi.png",tt.modifyImage(d,"曹原",90,90)  
//        //往图片上写文件  
//         );  
  
        tt.writeImageLocal("D:\\xinxi\\new01.png", tt.modifyImagetogeter(xz, zt));  
        //将多张图片合在一起  
